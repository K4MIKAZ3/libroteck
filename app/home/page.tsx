...
export default async function HomePage() {
  ...
  return (
    <StoreShell store={store} settings={settings} storeSlug={slug}>
      <section className="bg-hero-gradient hero-section mb-10 grid items-center gap-10 overflow-hidden rounded-[32px] px-6 py-12 text-white sm:px-10 sm:py-14 lg:grid-cols-[1.1fr_0.9fr]">
        <div>
          ...
          <p className="mt-5 max-w-xl text-lg leading-relaxed text-[var(--hero-subtitle)]">
            {isStreaming
